...
async def validate_price_data_file(
    ...
    Performs 4 layers of validation:
...
def get_service_info():
    ...
    return {
        ...
        "description": "Validates Price Data datasets (XLSX) with 4 layers of validation. "
                       "Compares templates, detects commodity/market/date columns, "
        ...
        "outputs": {
            ...
            "column_roles": "Detected columns for commodity, market, and date",
            "product_classifications": "Commodity name suggestions from the LLM",
            "final_report": "Deterministic diagnostic report",
            "success": "True if all layers passed"
        },
        "layers": [
            {"id": 1, "name": "XLSX Validation", "description": "Checks XLSX integrity and loads the file"},
            {"id": 2, "name": "Template Comparison", "description": "Compares submitted columns to the template"},
            {"id": 3, "name": "Content Validation", "description": "Validates commodity, market, and date values"},
            {"id": 4, "name": "Deterministic Report", "description": "Summarizes errors, locations, and fixes"}
        ],
