...
RAW_REQUIRED_COLUMN_ALIASES: dict[str, set[str]] = {
    'SVYSTARTTIME': {'SVYSTARTTIME', 'SVY_START_TIME'},
    '_SUBMISSION_TIME': {'_SUBMISSION_TIME', 'SUBMISSION_TIME'},
    '_UOALATLNG_ALTITUDE': {'_UOALATLNG_ALTITUDE', 'UOALATLNG_ALTITUDE'},
    '_UOALATLNG_LATITUDE': {'_UOALATLNG_LATITUDE', 'UOALATLNG_LATITUDE'},
    '_UOALATLNG_LONGITUDE': {'_UOALATLNG_LONGITUDE', 'UOALATLNG_LONGITUDE'},
    '_UUID': {'_UUID', 'UUID'},
    'ADM0CODE': {'ADM0CODE', 'ADM0_CODE'},
    'ADM1CODE': {'ADM1CODE', 'ADM1_CODE'},
    'ADM2CODE': {'ADM2CODE', 'ADM2_CODE'},
    'ENUMNAME': {'ENUMNAME', 'ENUM_NAME', 'ENUMERATOR'},
    'INSTANCEID': {'INSTANCEID', 'INSTANCE_ID', 'RESPONSEID', 'RESPONSE_ID', '_ID'},
    'MARKETID': {'MARKETID', 'MARKET_ID'},
    'MARKETNAME': {'MARKETNAME', 'MARKET_NAME'},
    'SVYDATE': {'SVYDATE', 'SVY_DATE', 'SUBMISSIONDATE'},
    'SVYENDTIME': {'SVYENDTIME', 'SVY_END_TIME'},
